select t.clock_event_type, t.payroll_id, t.timezone, t.datetime from
    ...
    union all 
    select last_name as payroll_id, 'OUT' clock_event_type, 'Asia/Jarkata' timezone, to_char(coalesce(last_out_time, irst_in_time) ,'yyyy-mm-ddThh24:mi:ss') datetime from acc_firstin_lastout
